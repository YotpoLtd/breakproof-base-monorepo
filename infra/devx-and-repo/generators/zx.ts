...
/**
 * Until we migrate from hygen
 * (https://github.com/YotpoLtd/breakproof-base-monorepo/issues/45) we need to
 * replicate some of hygen settings in `zx`
 *
 * This is inside a function, to work around the CJS not being able to use
 * top-level await.
 */
