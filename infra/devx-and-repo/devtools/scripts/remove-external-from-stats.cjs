/**
 * The only purpose of this script is to read the compilation-stats.json
 * generated by webpack and remove the external packages from it so that it's
 * easier to analyze the internal dependency graph.
 */
